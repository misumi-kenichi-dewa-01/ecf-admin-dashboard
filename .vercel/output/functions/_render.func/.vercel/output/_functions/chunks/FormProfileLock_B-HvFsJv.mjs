...
const $$FormProfileLock = createComponent(($$result, $$props, $$slots) => {
...
}, "/Users/kenichi_dewa/Documents/git_projects/ecf-admin-dashboard/src/modules/FormProfileLock.astro", void 0);

export { $$FormProfileLock as $ };
