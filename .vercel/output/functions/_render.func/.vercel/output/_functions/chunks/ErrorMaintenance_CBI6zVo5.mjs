import { l as createComponent, m as renderTemplate, n as maybeRenderHead, o as addAttribute } from './astro/server_DbSP0ska.mjs';
import 'kleur/colors';
import 'clsx';
import { a as asset, u as url } from './LayoutCommon_DVNMGefn.mjs';

const $$ErrorMaintenance = createComponent(($$result, $$props, $$slots) => {
...
}, "/Users/kenichi_dewa/Documents/git_projects/ecf-admin-dashboard/src/modules/ErrorMaintenance.astro", void 0);

export { $$ErrorMaintenance as $ };
