...
const $$ErrorServer = createComponent(($$result, $$props, $$slots) => {
...
}, "/Users/kenichi_dewa/Documents/git_projects/ecf-admin-dashboard/src/modules/ErrorServer.astro", void 0);

export { $$ErrorServer as $ };
