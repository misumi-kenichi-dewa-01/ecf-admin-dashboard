...
import 'kleur/colors';
import 'clsx';
import { a as asset } from './LayoutCommon_DVNMGefn.mjs';

const $$FormForgotPassword = createComponent(($$result, $$props, $$slots) => {
...
}, "/Users/kenichi_dewa/Documents/git_projects/ecf-admin-dashboard/src/modules/FormForgotPassword.astro", void 0);

export { $$FormForgotPassword as $ };
